...
from hoymiles_mqtt.jeedom import JeddomMqtt
...
class HoymilesQueryJob:
    ...
    def __init__(self, mqtt_builder: JeddomMqtt, mqtt_publisher: MqttPublisher, modbus_client: HoymilesModbusTCP):
        ...
        """
        self._mqtt_builder: JeddomMqtt = mqtt_builder
